...
- **Manager-only operations check `callerEmp.isManager`.** Any new
  ...
  privilege escalation. **EXCEPTION — the admin tier (INV-136):** the **47**
  Admin-exclusive endpoints (32 Manage-module Admin-tab config/system/roster
