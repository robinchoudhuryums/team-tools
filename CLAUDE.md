...
- **The 2026-08-25 operator round (batches 1–6: intake polish, Spanish
  ...
  redeploy; blanking either disables the voicemail path. NO new triggers,
  migrations, or OAuth scopes; one new manager endpoint
  (`getIntakeVolumeStats`) and one rep endpoint (`searchInsurancePayors`);
