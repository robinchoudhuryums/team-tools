...
- **Two-stage email is the safety mechanism.** Submit logs only,
  ...
  **The save-then-preview ORDER is load-bearing:** `cnComposerGoToPreview_`
  ...
  only) — that is the hash guard working, not a gap. Issue/Resolution show RAW
