  ...
  var FIXTURES = {
    ...
    searchInsurancePayors: { total: 3, cap: 8, matches: [
      { name: 'AETNA NETWORK GOLD S Plan Number 000001-EXTX0107', networkStatus: 'status not recorded',
        ...
        details: [
          // T3: the server names each code column from the pricing tab. K0800
          // resolves to one item, K0802 to none (the pricing tab does not carry
          // it), K0814 to two, and the last is the shorthand that REFUSES.
          { label: 'K0800', value: 'Location-based ( Up To 285) & SI/PR',
            code: { shaped: true, certain: true, tokens: ['K0800'] }, item: 'Drive Scout 3 Wheel', itemCount: 1 },
          { label: 'K0801', value: 'Location-based ( 285-325 lb) SI/PR',
            code: { shaped: true, certain: true, tokens: ['K0801'] }, item: '', itemCount: 0 },
          { label: 'K0802', value: 'Not Accepted',
            code: { shaped: true, certain: true, tokens: ['K0802'] }, item: '', itemCount: 0 },
          { label: 'K0814', value: 'SI/PR',
            code: { shaped: true, certain: true, tokens: ['K0814'] }, item: '', itemCount: 2 },
          { label: 'K0821/23/16', value: 'TRY',
            code: { shaped: true, certain: false, tokens: [] }, item: '', itemCount: 0 },
          { label: 'Category', value: 'POV/Scooter',
            code: { shaped: false, certain: false, tokens: [] }, item: '', itemCount: 0 }] },
    ...
    searchOopPricing: { total: 2, cap: 8, matches: [
      ...
      // The shorthand, on the ITEM side: shown, never matched to a payor rule.
      { name: 'Bariatric Transfer Bench', code: 'K0821/23/16', effective: '', eligibility: 'TX, OK',
